...
torchrun \
    ...
    --target-model-path /home/zhaode.wzd/workspace/Qwen3-VL-4B-Instruct \
    --draft-model-config $ROOT_DIR/configs/qwen3-vl-4b-eagle3.json \
    --train-data-path $ROOT_DIR/cache/dataset/mix.jsonl \
    --output-dir $ROOT_DIR/outputs/Qwen3-VL-4B-Instruct-eagle3 \
    ...
    --ttt-length 7 \
    --report-to swanlab \
    --swanlab-name Qwen3-VL-4B-Instruct-EAGLE3 \
